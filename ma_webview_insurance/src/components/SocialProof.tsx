...
import { Star, CheckCircle2, MessageSquareHeart, Laptop, Zap, Bike, LucideIcon } from "lucide-react";
  ...
  const reviews: ReviewItem[] = [
    {
      ...
      icon: Laptop,
      iconBg: "bg-fuchsia-500/15 text-fuchsia-600 dark:text-fuchsia-400 border border-fuchsia-500/20",
      rating: 5,
            ...
            return (
              ...
              >
                ...
                <div className="mt-6 pt-4 border-t border-white/20 dark:border-slate-800 flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-2xl ${rev.iconBg} flex items-center justify-center shadow-xs shrink-0`}>
