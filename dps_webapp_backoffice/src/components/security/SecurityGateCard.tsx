      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center gap-3.5">
            <div className="w-12 h-12 rounded-2xl bg-indigo-50 dark:bg-indigo-950/70 border border-indigo-100 dark:border-indigo-800/60 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold text-2xl shadow-sm">
              🛡️
            </div>
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Two-tier security audit: Static code scanning (Gate 1) & Nexus artifact verification (Gate 2).
              </p>
            </div>
          </div>
        </div>
        ...
        {/* ========================================================================= */}
        <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-850/40 border border-slate-200/90 dark:border-slate-800 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <span className="w-6 h-6 rounded-lg bg-indigo-600 dark:bg-indigo-500 text-white flex items-center justify-center text-xs font-bold shadow-sm">
                1
              </span>
        ...
        <div className="p-5 rounded-2xl bg-slate-50 dark:bg-slate-850/40 border border-slate-200/90 dark:border-slate-800 space-y-4">
          ...
          {gate2Report ? (
            <div className="space-y-3">
              <div className="p-4 rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs space-y-2.5 shadow-sm">
                <div className="flex items-center justify-between">
                ...
                <div className="p-2.5 bg-slate-100 dark:bg-slate-900/90 rounded-lg border border-slate-200 dark:border-slate-800 font-mono text-[11px] text-slate-800 dark:text-slate-200 break-all select-all">
        ...
        {/* ========================================================================= */}
        <div className="p-4 rounded-xl border flex items-center justify-between text-xs bg-slate-50 dark:bg-slate-800/60 border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-2.5">
            <span className="text-base">{gate1Passed ? '✅' : '⚠️'}</span>
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400 mt-0.5">
                {gate1Passed
                  ? 'All security gates satisfied. Use the Actions (...) menu in the header above to Approve or Reject this Mini App.'
