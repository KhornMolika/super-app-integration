          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <Input 
                ...
                className={`font-mono text-base bg-slate-50 dark:bg-slate-900/50 text-slate-500 cursor-not-allowed ${allErrors.appId ? 'border-rose-500 ring-1 ring-rose-500 focus:ring-rose-500 bg-rose-50/50' : ''}`}
              />
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 space-y-4">
                  <div className="flex items-center justify-between">
                    <h5 className="text-base font-bold uppercase tracking-wider text-slate-800 dark:text-slate-200">
                      Terms of Service
                    </h5>
                    <span className="text-xs text-slate-400 font-medium">Optional</span>
                  </div>
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Summary or key provisions of the Terms of Service.</p>
                    {allErrors.termsDescription && <p className="mt-1.5 text-sm text-rose-600 font-medium">{allErrors.termsDescription}</p>}
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/30 space-y-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="mt-1.5 text-sm text-slate-500 dark:text-slate-400">Summary or disclosures regarding data privacy and security.</p>
                    {allErrors.privacyPolicyDescription && <p className="mt-1.5 text-sm text-rose-600 font-medium">{allErrors.privacyPolicyDescription}</p>}
                  </div>
                </div>
              </div>
            </div>
