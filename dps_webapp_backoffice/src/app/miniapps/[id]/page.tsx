            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-teal-700 dark:text-teal-300 mt-0.5">
                  Integration review approved by SA Admin. Build and validate the Super App test container before moving to the TESTING phase for APK download.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-700 dark:text-indigo-300 mt-0.5">
                  The Super App container is assembling dependencies and compiling the test APK. Once validation succeeds, the Mini App will automatically advance to <strong>TESTING</strong> where the test APK will be available for download.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 flex-shrink-0">
