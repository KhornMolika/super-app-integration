...
# Replace the specific lifecycle diagram
lifecycle_regex = r'<div className="p-4 rounded-xl bg-slate-900 text-slate-200 font-mono text-sm overflow-x-auto">.*?</div>\s*</div>\s*<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">'

new_lifecycle = """{/* Modern Lifecycle Phases */}
...
content = re.sub(lifecycle_regex, new_lifecycle, content, flags=re.DOTALL)
