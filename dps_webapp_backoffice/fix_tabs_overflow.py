...
tabs_regex = r'\{\/\* Interactive Method Tabs \*\/\}\s*<div className="flex overflow-x-auto gap-8 border-b-2 border-slate-200 dark:border-slate-800 mb-8 mt-4 \[\&::\S+\]:hidden \[-ms-overflow-style:none\] \[scrollbar-width:none\]">.*?<\/button>\s*\)\)\}\s*<\/div>'
